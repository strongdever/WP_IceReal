...
<main>
	...
	<section class="p_main_section">
      ...
      <div class="p_archive_cat">
        <h3 class="lead">ペット不動産物件</h3>
        <h4 class="sub">Pet friendly real estate</h4>
      </div>
        ...
        <?php foreach( $child_categories as $child_category ) : ?>
          <li>
            ...
            <div class="p_archive_action">
              <a href="<?php echo HOME . 'pet/' . $child_category->slug; ?>" class="action_btn mx_auto">
                <span>view all　></span>
              </a>
            </div>
            <?php endif; ?>
